    ...
    <>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          ...
          >
            <span className={`ham-line ${menuOpen ? 'ham-open-1' : ''}`} style={{
              display: 'block', height: '1.5px', background: '#f5f0e8',
              width: '22px', transition: 'transform 0.3s ease, opacity 0.3s ease',
            }} />
            <span className={`ham-line ${menuOpen ? 'ham-open-2' : ''}`} style={{
              display: 'block', height: '1.5px', background: '#f5f0e8',
              width: '14px', transition: 'transform 0.3s ease, width 0.3s ease',
            }} />
          </button>
        </div>
      </nav>
      ...
      {menuOpen && (
        ...
        >
          ...
          <div style={{
            ...
            <span style={{ display: 'block', width: '5px', height: '5px', borderRadius: '50%', background: '#c9a96e' }} />
            <span style={{
              fontFamily: '"Inter", sans-serif', fontSize: '0.7rem',
              letterSpacing: '0.18em', textTransform: 'uppercase', color: '#6b6b6b',
            }}>
              Porto, Portugal
            </span>
          </div>
